    ...
    config: {
       ...
       // cls: 'x-list-show',
		...
		/*itemTpl: ["<div><table class=\"listtable\"><tr><td valign=\"top\" width=\"95%\" ><div class=\"td1\"> <b style=\"font-weight:normal\">{RESPCTIVEDESCRIPTION}</b></div></td><td rowspan=\"4\"><img src=\"resources/images/NextArrow.png\" style=\"width: 15px;height:15px\" /></td></tr><tr><td valign=\"top\" class=\"wrap-style font-color-white\" width=\"95%\"><b style=\"font-weight:normal\"> {Amount} </b></td></tr><tr><td valign=\"top\" class=\"td2\"  width=\"95%\">Start&nbsp;Date&nbsp;&nbsp;&nbsp;&nbsp;Due&nbsp;Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;From</td></tr><tr><td valign=\"top\"  style=\"color:#C7E3FF;font-size:14px;\" width=\"95%\">{APPROVALREQUESTEDDATE}&nbsp;&nbsp;&nbsp;&nbsp;{APPROVALREQUESTEDBY}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{FROMUSER}</td></tr></table></div>"] ,*/
				...
				itemTpl: ["<span><table  class=\"listtable\" ><tr><td valign=\"top\" width=\"95%\" ><div class=\"td1\"> <b>{RESPCTIVEDESCRIPTION}</b></div></td></tr></table><table  width=\"95%\"><tr><td valign=\"top\"  width=\"95%\" colspan=\"3\" style=\"color:#ffffff;font-size:19px;font-weight:normal\" ><b>{Amount} </b></td></tr><tr class=\"td2\"><td valign=\"top\"  width=\"18%\">Start Date</td><td valign=\"top\" width=\"18%\">Due Date</td><td valign=\"top\" width=\"49%\">From</td></tr></table><table  width=\"95%\"><tr style=\"color:#C7E3FF;font-size:14px;\"><td valign=\"top\"   width=\"18%\">{APPROVALREQUESTEDDATE}</td><td width=\"18%\" valign=\"top\">{APPROVALREQUESTEDBY}</td><td width=\"49%\" valign=\"top\">{FROMUSER}</td></tr></table></span><span><img class=\"secondviewarrow\" src=\"resources/images/NextArrow.png\" /></span>"],	
