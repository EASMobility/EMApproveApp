...
var IOSDeviceToken = function (devToken) {
    devTokenFromIOS = devToken;
    
};
var NotificationCalled = function (isTrue) {
    var NotCalledFlag = isTrue;
    if (NotCalledFlag == 'True') {
       if (localStorage.getItem('sessionToken') != null) {
            worklistrequest(localStorage.getItem('urlValue'), localStorage.getItem('sessionToken'),true);
            ERworklistrequest(localStorage.getItem('urlValue'), localStorage.getItem('sessionToken'),true);
        }
    }
};