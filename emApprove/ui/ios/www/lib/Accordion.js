Ext.define('ux.layout.Accordion', {
    ...
    constructor: function(container) {
        ...
        if (this.getMode() === 'SINGLE') {
        	...
        	container.on('show', 'checkMultiMode', this, { single : true });
        }
    },
    ...
    collapse: function(component) {
        if (component.isInnerItem() && !(this.getMode() === 'SINGLE' && this.getExpandedItem() === component)) {
            ...
            component.fullHeight = component.element.getHeight();
               ...
               if(component.id == 'ext-container-2')
            	   {
            	   Ext.getCmp('erlist').hide();
            	   Ext.getCmp('erlist').addCls('minimised_ercontainer2');
            	   }else if(component.id == 'ext-container-5'){
            		   Ext.getCmp('polist').hide();
            		   Ext.getCmp('polist').addCls('minimised_pocontainer5');
            	   }else if(component.id == 'ext-container-8'){
    ...
    getTitle: function(index){
    	...
    	case 0:return "Expense Report";
    	case 1:return "Purchase Order";
    	case 2:return "Purchase Requisition";
    	default: return "Test";
    	}
